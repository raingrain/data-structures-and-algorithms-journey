...
![image](./images/Kruskal重构树1.png)

![image](./images/Kruskal重构树2.png)

![image](./images/Kruskal重构树3.png)

## [P2245 星际导航](https://www.luogu.com.cn/problem/P2245)

> - **Question**
>   - 图里有 `n` 个点， `m` 条无向边，每条边给定边权，图里可能有若干个连通的部分，一共有 `q` 条查询，每条查询都是如下的格式，查询 `x y` 点 `x` 和点 `y` 希望连通起来，其中的最大边权希望尽量小，打印这个值，如果怎样都无法联通，打印 `impossible` 。
>   - **Tips**
>     - `1 <= n <= 10^5`
>     - `1 <= m <= 3 * 10^5`
>     - `1 <= q <= 10^5`
