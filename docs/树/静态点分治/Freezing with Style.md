...
## [E. Freezing with Style](https://codeforces.com/problemset/problem/150/E)

> - **Question**
>   - 一共有 `n` 个节点，给定 `n - 1` 条边，每条边给定边权，所有节点组成一棵树，一条简单路径上，收集所有边权组成序列，其中的下中位数作为路径的权，边数在 `[limitl, limitr]` 范围的所有路径中，找到最大权的路径，如果有多条路径，找到其中一个方案即可，打印两个端点。
>   - **Tips**
>     - `1 <= n <= 10^5`
>     - `0 <= 边权 <= 10^9`
