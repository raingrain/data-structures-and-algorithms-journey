...
## [P6419 [COCI2014-2015#1] Kamp](https://luogu.com.cn/problem/P6419)

> - ***Question***
>   - 给定一棵 `n` 个点的树，边权代表走过边需要花费的时间。给定 `k` 个人分别在树上的哪些节点。这 `k` 个人选择了一个聚会点，所有的人都去往聚会点进行聚会。聚会结束后，所有人都会上一辆车，车会把每个人送回家。送完最后一个乘客，车不需要回到聚会点。如果聚会点在 `i` ，请问从聚会地点出发直到送最后一个人回家，最短用时多少。 `i = 1 ~ n` ，打印所有的答案。
